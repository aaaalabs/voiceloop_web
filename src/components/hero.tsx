...
export const Hero = ({
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-8 flex flex-col min-h-screen pt-20 sm:pt-32 md:pt-48 relative">
      <motion.h1
        initial={{ y: 40, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ ease: "easeOut", duration: 0.5 }}
        className="text-6xl xs:text-7xl sm:text-8xl md:text-9xl lg:text-11xl font-black tracking-[-0.01em] leading-[0.9] sm:leading-none max-w-6xl mx-auto text-center relative z-10 antialiased px-4"
      >
