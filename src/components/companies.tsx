...
export const Companies = () => {
  ...
  return (
    <div className="relative z-20 py-10 md:py-40 bg-[#F3EDE5] dark:bg-[#1D3640] rounded-2xl px-8">
      ...
      <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-[#F3EDE5] dark:from-[#1D3640]" />
      <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#F3EDE5] dark:from-[#1D3640]" />
    </div>
  );
};
